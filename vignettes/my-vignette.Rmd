...
The evaluation methods in Example 4 enable us to evaluate the graphs from different aspects. The last problem is to find the optimal graphs regarding these measures. We solve this problem borrowing methods for the multi-objective optimization problems.
