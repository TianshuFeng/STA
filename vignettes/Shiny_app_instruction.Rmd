...
This page introduces the __[Shiny app](http://tsfeng.shinyapps.io/STA-app)__ designed to interactively analysis results from the `mapper.kmeans` function of package STA. 
...
| ![Interface](man/figures/main_screen.png) | 
|:--:| 
...
| ![node_sum](man/figures/Node_summary.png) | 
|:--:| 
...
| ![conti_color](man/figures/continuous_color.png) | 
|:--:| 
...
For example, 
| ![node_sum_conti](man/figures/node_summary_continuous.png) | 
|:--:| 
...
| ![node_compare](man/figures/node_comparison.png) | 
|:--:| 
| *Node comparison. * |
...
| ![node_custom](man/figures/settings.png) | 
|:--:| 
