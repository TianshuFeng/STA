...
This page introduces the [Shiny app](https://tianshufeng.github.io/STA/articles/Shiny app.html) designed to interactively analysis results from the `mapper.kmeans` function of package STA. 
...
| ![node_sum](figures/Node_summary.png) | 
|:--:| 
...
| ![conti_color](figures/continuous_color.png) | 
|:--:| 
...
For example, 
| ![node_sum_conti](figures/node_summary_continuous.png) | 
|:--:| 
...
| ![node_compare](figures/node_comparison.png) | 
|:--:| 
| *Node comparison. * |
...
| ![node_custom](figures/settings.png) | 
|:--:| 
